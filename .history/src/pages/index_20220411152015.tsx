  ...
  return (
    ...
    >
      <h1 className="text-2xl font-bold">
        JPEG images into AVIF images from OpenSea user Gh0stly Gh0sts.
      </h1>
          ...
          <li key={file.source} className="relative">
            <div className="group  block w-full overflow-hidden rounded-lg bg-gray-100 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 focus-within:ring-offset-gray-100">
              <Imgix
                ...
                sizes="(min-width: 1280px) 168px, (min-width: 1024px) 174px, (min-width: 776px) 740px, (min-width: 640px) 30vw, 45vw"
                alt={file.title}
